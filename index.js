...
const KB = {
    ...
    msk: 'Москва',
    zelen: 'Зеленоград',
    tovar1: '0.3gr.+0.5gr. СВАО ВДНХ',
    tovar2: '0.5gr.+0.5gr. СВАО ВДНХ',
    tovar3: '1gr.+0.5gr. СВАО ВДНХ',
    tovar4: '0.3gr.+0.5gr. СВАО ВДНХ',
    tovar5: '0.3gr.+0.5gr. ЦАО',
    tovar6: '3gr. ЦАО',
    tovar7: '0.5gr.+0.5gr. ЦАО',
    tovar8: '5gr. ЦАО',
    tovar9: '1gr. ЧЕРТАНОВО',
    tovar10: '0.3gr.+0.5gr. ЧЕРТАНОВО',
    tovar11: '3gr. ЧЕРТАНОВО',
    tovar12: '0.5gr.+0.5gr. ЧЕРТАНОВО',
    tovar13: '1gr. БУТОВО',
    tovar14: '3gr. БУТОВО',
    tovar15: '5gr. БУТОВО',
    tovar16: '1gr.+0.5gr. БУТОВО',
    tovar17: '1gr. ЛЮБЕРЦЫ',
    tovar18: '0.3gr.+0.5gr. ЛЮБЕРЦЫ',
    tovar19: '5gr. ЛЮБЕРЦЫ',
    tovar20: '1gr.+0.5gr. ЛЮБЕРЦЫ',
    bitcoin1: 'BTC 0,00100000 0.3gr.+0.5gr. СВАО ВДНХ',
    bitcoin2: 'BTC 0,00120000 0.5gr.+0.5gr. СВАО ВДНХ',
    bitcoin3: 'BTC 0,00240000 1gr.+0.5gr. СВАО ВДНХ',
    bitcoin4: 'BTC 0,00340000 0.3gr.+0.5gr. СВАО ВДНХ',
    bitcoin5: 'BTC 0,00100000 0.3gr.+0.5gr. ЦАО',
    bitcoin6: 'BTC 0,00110000 3gr. ЦАО',
    bitcoin7: 'BTC 0,00120000 0.5gr.+0.5gr. ЦАО',
    bitcoin8: 'BTC 0,00150000 5gr. ЦАО',
    bitcoin9: 'BTC 0,00060000 1gr. ЧЕРТАНОВО',
    bitcoin10: 'BTC 0,00100000 0.3gr.+0.5gr. ЧЕРТАНОВО',
    bitcoin11: 'BTC 0,00110000 3gr. ЧЕРТАНОВО',
    bitcoin12: 'BTC 0,00120000 0.5gr.+0.5gr. ЧЕРТАНОВО',
    bitcoin13: 'BTC 0,00060000 1gr. БУТОВО',
    bitcoin14: 'BTC 0,00110000 3gr. БУТОВО',
    bitcoin15: 'BTC 0,00150000 5gr. БУТОВО',
    bitcoin16: 'BTC 0,00240000 1gr.+0.5gr. БУТОВО',
    bitcoin17: 'BTC 0,00060000 1gr. ЛЮБЕРЦЫ',
    bitcoin18: 'BTC 0,00100000 0.3gr.+0.5gr. ЛЮБЕРЦЫ',
    bitcoin19: 'BTC 0,00150000 5gr. ЛЮБЕРЦЫ',
    bitcoin20: 'BTC 0,00240000 1gr.+0.5gr. ЛЮБЕРЦЫ',
    qiwi1: 'QIWI 1000р. 0.3gr.+0.5gr. СВАО ВДНХ',
    qiwi2: 'QIWI 1200р. 0.5gr.+0.5gr. СВАО ВДНХ',
    qiwi3: 'QIWI 2400р. 1gr.+0.5gr. СВАО ВДНХ',
    qiwi4: 'QIWI 3400р. 0.3gr.+0.5gr. СВАО ВДНХ',
...
bot.onText(/\/start/, msg => {
    ...
    const text = 'Добро пожаловать в автомагазин\n' +
        ...
        'Сайт: !!!ТЕХНИЧЕСКИЕ РАБОТЫ!!! ВСЕМ ЗАРЕГИСТРИРОВАННЫМ ПОЛЬЗОВАТЕЛЯМ СРОЧНО ОТПИСАТЬ ОПЕРАТОРУ!!!\n' +
        '➖➖➖➖➖➖➖➖➖➖\n' +
    ...
    switch (msg.text) {
        ...
        case KB.priv:
            bot.sendMessage(msg.chat.id, "АКЦИЯ 'ЕЖЕДНЕВНЫЙ ПРИВНОТ' ОТ FAST SHOP\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "Привноты обновляются ежедневно с 12 по 19 часов по МСК\n" +
                "Стандартно в привнотах лежит адрес с KRIS-A29+BONUS'GreenDevil' 0.3gr.+0.5gr. либо с  ROSS'GreenDevil' 3gr.\n" +
                "В праздничные дни выдаются привноты с !!!БОЛЕЕ ЩЕДРЫМИ ПОЗИЦИЯМИ!!!\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
        ...
        case KB.bitcoin1:
            bot.sendMessage(msg.chat.id, "Вы приобретаете:\n" +
                ...
                "Город: МОСКВА\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "Для получения товара оплатите 0,00100000 BTC на указанные реквизиты:\n" +
                "\n" +
                "*BTC*\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
        ...
        case KB.bitcoin2:
            bot.sendMessage(msg.chat.id, "Вы приобретаете:\n" +
                ...
                "Город: МОСКВА\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "Для получения товара оплатите 0,00120000 BTC на указанные реквизиты:\n" +
                "\n" +
                "*BTC*\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "После оплаты нажмите пункт 'Проверка заказа' в меню ниже" , {
        ...
        case KB.bitcoin4:
            bot.sendMessage(msg.chat.id, "Вы приобретаете:\n" +
                ...
                "Город: МОСКВА\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "Для получения товара оплатите 0,00340000 BTC на указанные реквизиты:\n" +
                "\n" +
                "*BTC*\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "После оплаты нажмите пункт 'Проверка заказа' в меню ниже" , {
        ...
        case KB.bitcoin6:
            bot.sendMessage(msg.chat.id, "Вы приобретаете:\n" +
                ...
                "Город: МОСКВА\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "Для получения товара оплатите 0,00110000 BTC на указанные реквизиты:\n" +
                "\n" +
                "*BTC*\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "После оплаты нажмите пункт 'Проверка заказа' в меню ниже" , {
        ...
        case KB.bitcoin8:
            bot.sendMessage(msg.chat.id, "Вы приобретаете:\n" +
                ...
                "Город: МОСКВА\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "Для получения товара оплатите 0,00150000 BTC на указанные реквизиты:\n" +
                "\n" +
                "*BTC*\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "После оплаты нажмите пункт 'Проверка заказа' в меню ниже" , {
        ...
        case KB.bitcoin9:
            bot.sendMessage(msg.chat.id, "Вы приобретаете:\n" +
                ...
                "Город: МОСКВА\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "Для получения товара оплатите 0,00060000 BTC на указанные реквизиты:\n" +
                "\n" +
                "*BTC*\n" +
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "После оплаты нажмите пункт 'Проверка заказа' в меню ниже" , {
