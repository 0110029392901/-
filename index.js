...
bot.onText(/\/start/, msg => {
    ...
    const text = 'Добро пожаловать в автомагазин\n' +
        'FAST SHOP MSK 24/7\n' +
        '➖➖➖➖➖➖➖➖➖➖\n' +
        'Наш канал отзывов: https://t.me/FASTMSK' +
        'Оператор @FASTMSK_HELP\n' +
        'Оптовые покупки JABBER:\n' +
        'Сайт: https://fastmsk.biz !!!ВНИМАНИЕ!!!ТЕХНИЧЕСКИЕ РАБОТЫ!!! ВСЕМ ЗАРЕГИСТРИРОВАННЫМ ПОЛЬЗОВАТЕЛЯМ СРОЧНО ОТПИСАТЬ ОПЕРАТОРУ!!!\n' +
        '➖➖➖➖➖➖➖➖➖➖\n' +
    ...
    switch (msg.text) {
        ...
        case KB.price:
            bot.sendMessage(msg.chat.id, "В наличии:\n" +
                ...
                "➖➖➖➖➖➖➖➖➖➖\n" +
                "    ЧЕРТАНОВО:\n" +
                "KRIS-A29+BONUS ROSS\\'GreenDevil\\' 1gr. - 600.\n" +
                "KRIS-A29+BONUS ROSS\\'GreenDevil\\' 0.3gr.+0.5gr. - 1000р.\n" +
                "ROSS\\'GreenDevil\\' 3gr. - 1100р.\n" +
                "KRIS-A29+BONUS ROSS\\'GreenDevil\\' 0.5gr.+0.5gr. - 1200р.\n" +
                "\n" +
        ...
        case KB.zelen:
            bot.sendMessage(msg.chat.id, "В данном городе закончились товары\n" +
                ...
                "Для оформления предзаказа необходимо ОТПИСАТЬ ОПЕРАТОРУ @FASTMSK_HELP"
                , {
                reply_markup: {
                    keyboard: [
                        [KB.back]
