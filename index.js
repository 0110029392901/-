...
const KB = {
    ...
    bitcoin4: 'BTC 0,00340000 3gr.+0.5gr. СВАО ВДНХ',
...
bot.onText(/\/start/, msg => {
    ...
    const text = 'Добро пожаловать в автомагазин\n' +
        ...
        'Сайт: https://fastmsk.biz !!!ТЕХНИЧЕСКИЕ РАБОТЫ!!! ВСЕМ ЗАРЕГИСТРИРОВАННЫМ ПОЛЬЗОВАТЕЛЯМ СРОЧНО ОТПИСАТЬ ОПЕРАТОРУ!!!\n' +
        '➖➖➖➖➖➖➖➖➖➖\n' +
